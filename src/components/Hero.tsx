...
export default function Hero() {
  ...
  <section className="relative ml-[calc(50%-50vw)] flex w-screen flex-col overflow-hidden rounded-b-3xl lg:h-[690px]">
      ...
      {/* Content — capped at 1440px and centered, independent of the full-bleed background */}
      <div className="relative mx-auto flex w-full max-w-[1440px] flex-1 flex-col lg:h-full">
        {/* Hero content */}
